...
2026-08-28時点の内訳（掲載28件）: 27卒 8 ／ 28卒 5 ／ 既卒・第二新卒 4 ／ **記載なし 11**。
...
- ⚠ **`既卒・第二新卒` と `通年・年次不問` と未入力は落とさない。**
  中途サイトも `区分≠中途` で弾くので、ここから外すと**どちらのサイトにも出ない求人**ができてしまう。
  第二新卒4件がまさにそれに当たる（区分は「新卒」なので中途サイトには出ない）。
